  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} >
      <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Powered by Right Apps</Text>
      </View>
      <ScrollView style={[styles.content, isDesktop && responsive.padding, isTablet && responsive.tabletPadding]} showsVerticalScrollIndicator={false} >
        {/* Profile Section */}
