...
export default function HistoryScreen() {
  ...
  useEffect(() => {
    ...
    events.forEach(event => eventBus.on(event, loadOrderStats));
    return unsubscribe;
   
  }, []); // ✅ Empty dependency array — no multiple subscriptions
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background, borderColor: colors.border}]}>
      <View style={[styles.header, {backgroundColor: colors.card}]}>
        ...
        <TouchableOpacity 
          style={[styles.refreshButton, isRefreshing && { backgroundColor: colors.card }]}
      ...
      <View style={styles.statsContainer, isDesktop && responsive.padding, isTablet && responsive.tabletPadding}>
