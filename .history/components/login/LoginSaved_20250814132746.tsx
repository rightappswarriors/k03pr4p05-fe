               ...
               <View style={styles.content}>
                    ...
                    <View style={[styles.form, isDesktop && responsive.desktopPadding, isTablet && responsive.tabletPadding]}>
                         <View style={styles.inputContainer}>
                              <View style={[styles.passwordContainer, { backgroundColor: colors.card, borderColor: colors.border, outline: 'none'}]}>
                                   <TextInput
                                        style={[styles.passwordInput, {color: colors.text, borderWidth: 0},]}
