...
export default function FloatingBadge() {
     ...
     return (
          <>
               {showDialog && (
                    <View style={[styles.dialogBox, {backgroundColor: colors.card}, isMobile && { bottom: 80}]}>
               ...
               <TouchableOpacity
                    ...
                    activeOpacity={0.6}
               >
                    <View style={[styles.floatingButton, { backgroundColor: colors.background }, isMobile && { bottom: 110}]}>
