...
export function CartSidebar({
  ...
  return (
    <>
      ...
      <Animated.View
        style={[
          isDesktop ? styles.desktopSidebar : styles.mobileSidebar,
          {
            width: SIDEBAR_WIDTH,
            transform: isDesktop ? [] : [{ 
      ...
      >
        {/* Header */}
        <View style={[styles.header, { backgroundColor: colors.surface, borderColor: colors.border}]} className='transition-all duration-200'>
          {!isDesktop && (
        ...
        {/* Cart Items */}
        <ScrollView style={[styles.itemsList, {backgroundColor: colors.background}]} showsVerticalScrollIndicator={false}>
          {items.length === 0 ? (
              ...
              <View key={item.id} style={[styles.cartItem, { borderColor: colors.border}]}>
                ...
                <View style={styles.itemDetails}>
                  ...
                  <View style={styles.quantityContainer}>
                    ...
                    <TextInput
                      style={[styles.quantityInput, { backgroundColor: colors.card, borderColor: colors.border, color: colors.textSecondary}]}
