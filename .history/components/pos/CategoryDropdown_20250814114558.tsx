...
const CATEGORIES = {
  'A-Z': {
    'A': ['Apple', 'Apricots', 'Adidas', 'Amazon', 'Adobe'],
    'B': ['Bolt', 'Baker Hughes', 'BMW', 'Burger King', 'Banana'],
    'C': ['Coca Cola', 'Canon', 'Chevrolet', 'Coffee', 'Chocolate'],
    'D': ['Dell', 'Disney', 'Dominos', 'Dairy', 'Drinks'],
    'E': ['Electronics', 'Energy', 'Entertainment', 'Equipment'],
    'F': ['Ford', 'Facebook', 'Food', 'Fashion', 'Fruits'],
    'G': ['Google', 'General', 'Gaming', 'Groceries'],
    'H': ['HP', 'Honda', 'Health', 'Home'],
    'I': ['Intel', 'IBM', 'Ice Cream', 'Items'],
    'J': ['Johnson', 'Juice', 'Jewelry'],
    'K': ['KFC', 'Kitchen', 'Kids'],
    'L': ['LG', 'Lenovo', 'Lunch', 'Lifestyle'],
    'M': ['Microsoft', 'McDonald\'s', 'Mobile', 'Music'],
    'N': ['Nike', 'Netflix', 'Nutrition', 'Notebooks'],
    'O': ['Oracle', 'Office', 'Organic', 'Outdoor'],
    'P': ['Pizza', 'Pepsi', 'Personal', 'Phones'],
    'Q': ['Quality', 'Quick'],
    'R': ['Red Bull', 'Restaurant', 'Retail'],
    'S': ['Samsung', 'Starbucks', 'Sports', 'Snacks'],
    'T': ['Toyota', 'Tesla', 'Technology', 'Toys'],
    'U': ['Uber', 'Utilities', 'Uniforms'],
    'V': ['Visa', 'Vegetables', 'Vehicles'],
    'W': ['Walmart', 'Water', 'Wireless'],
    'X': ['Xbox', 'Xerox'],
    'Y': ['YouTube', 'Yoga'],
    'Z': ['Zoom', 'Zone']
  },
  'Brand A-Z': {
    'A': ['Apple', 'Adidas', 'Amazon', 'Adobe', 'Audi'],
    'B': ['BMW', 'Burger King', 'Baker Hughes', 'Bolt'],
    'C': ['Coca Cola', 'Canon', 'Chevrolet', 'Cisco'],
    'D': ['Dell', 'Disney', 'Dominos'],
    'F': ['Ford', 'Facebook'],
    'G': ['Google', 'General Electric'],
    'H': ['HP', 'Honda', 'Huawei'],
    'I': ['Intel', 'IBM'],
    'J': ['Johnson & Johnson'],
    'K': ['KFC'],
    'L': ['LG', 'Lenovo'],
    'M': ['Microsoft', 'McDonald\'s'],
    'N': ['Nike', 'Netflix', 'Nokia'],
    'O': ['Oracle'],
    'P': ['Pepsi'],
    'S': ['Samsung', 'Starbucks', 'Sony'],
    'T': ['Toyota', 'Tesla'],
    'U': ['Uber'],
    'V': ['Visa'],
    'W': ['Walmart'],
...
const TABS = ['A-Z', 'Brand A-Z', 'Colors'];
...
export function CategoryDropdown({
  ...
  return (
    <View style={styles.container}>
      {
        <TouchableOpacity style={styles.filterInput} onPress={toggleDropdown}>
          ...
          >
            {Object.entries(groupCategories(sortedCategories, sortType)).map(([group, items]) => (
              <View key={group} style={styles.letterSection}>
                <Text style={styles.letterHeader}>{group}</Text>
