...
export function ItemGrid({ items, loading, viewMode, onAddToCart }: ItemGridProps) {
  ...
  if (loading) {
    return (
      <ScrollView style={[styles.container, {backgroundColor:colors.background}]} contentContainerStyle={styles.loadingContainer isDesktop && { styles.destopLoadingContainer}}>
