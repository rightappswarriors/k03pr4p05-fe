      ...
      <View style={styles.overlay}>
        <View style={[styles.modal, {backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <View style={[styles.content, { backgroundColor: colors.background}]}>
            ...
            <Text style={[styles.itemName, { color: colors.text}]}>{item.item.name}</Text>
            <Text style={[styles.itemPrice, { color: colors.text}]}>₱{item.item.price.toFixed(2)}</Text>
            ...
            <View style={styles.totalSection}>
              ...
              <Text style={styles.totalAmount}>₱{(item.item.price * quantity).toFixed(2)}</Text>
            </View>
          </View>
