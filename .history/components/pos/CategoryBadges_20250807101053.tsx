...
export function CategoryBadges({
  ...
  return (
    <>
      <View style={[styles.container, { backgroundColor: colors.card, borderColor: colors.border }]}>
        <TouchableOpacity className='gap-2 flex-row items-center' style={[styles.categoryBadge, { backgroundColor: colors.background, }]}><Filter size={15} color={colors.text} />
      ...
      <View className='flex h-[100%] hidden:true' style={{backgroundColor: colors.card}}></View>
    </>
  );
}
