...
export function SkeletonLoader({ viewMode }: SkeletonLoaderProps) {
  ...
  const getItemWidth = () => {
    ...
    if (availableWidth >= 1200) return (availableWidth - 32) / 4; // 4 columns
  ...
  return (
    <View style={[styles.gridSkeleton, { width: getItemWidth() }, isDesktop && { width: '24.3%'}, {backgroundColor: colors.card}]}>
