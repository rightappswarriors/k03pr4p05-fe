...
export interface FinanceDataTableRow {
  key: string | number;
  cells: React.ReactNode[];
}

export interface FinanceDataTableColumn {
  label: string;
  /** Relative flex weight for this column (defaults to 1). Not a pixel width. */
  width?: number;
  align?: 'left' | 'right' | 'center';
  /** Optional server-side sort field. DataTable never sorts rows locally. */
  sortKey?: string;
}
...
interface FinanceDataTableProps {
  ...
  onRowPress?: (row: FinanceDataTableRow) => void;
