...
import { Package, Calendar, ExternalLink } from 'lucide-react-native'
      ...
      >
        ...
        <View style={{ gap: 6, marginTop: 4 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <View>
              <Text style={{ fontSize: 10, color: colors.textSecondary }}>RFQs Consolidated</Text>
              <Text style={{ fontSize: 12, fontWeight: '600', color: colors.text }}>
                {(rfqIds.length || lineItems.length || 0)}
              </Text>
            </View>
          </View>
          ...
          {totalVat != null && (
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontSize: 10, color: colors.textSecondary }}>Total VAT</Text>
              <Text style={{ fontSize: 12, fontWeight: '600', color: colors.text }}>
                {formatPHP(totalVat)}
              </Text>
            </View>
