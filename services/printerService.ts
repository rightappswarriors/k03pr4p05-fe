    ...
    return `
      <html>
        ...
        <body id="receipt">
          ...
          <div class="center">${
            receipt.store.isVatRegistered ? 'VAT-Registered' : 'Non-VAT'
          }</div>
          <div class="center">PTU#: ${receipt.store.ptu}</div>
          <div class="center">BIR Accredation No: ${receipt.store.bir}</div>
          <table>
            <tr>  
              <td style="font-size: 10px; font-family: 'Courier New', monospace;">Terminal ID: POS-${receipt.store.id}</td>
              <td class="right" style="font-size: 10px; font-family: 'Courier New', monospace;">SN: ${receipt.store.id}</td>
            </tr>
            <tr>  
